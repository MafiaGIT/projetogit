        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <div class="account-wall">
                <img class="profile-img" src="./imagens/foto_conta.png"
                    alt="">
                <form class="form-signin" method="post" action="sessaoLoginCliente.php" id="formlogin" name="formlogin">
                    <input type="email"  name='email' class="form-control" placeholder="E-mail" required autofocus>
                <input type="password" name='senha' class="form-control" placeholder="Senha" required autofocus>
                
                <select class="form-control login-cliente" name="nivel_usuario">
                    <option name="nivel_usuario">Cliente</option>
                </select>
                <br>
